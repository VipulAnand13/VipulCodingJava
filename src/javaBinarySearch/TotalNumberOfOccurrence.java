...
public class TotalNumberOfOccurrence {
	...
	public static void main(String[] args) {
		...
		int[] arr= {1,3,3,3,4,4,4,4,4,5,7,9};
		
		int left=leftMostOccurrence( arr, 4);
		int right=rightMostOccurrence( arr, 4);
		
		System.out.println("TOtal number of occurrence is:" + (right -left + 1));
